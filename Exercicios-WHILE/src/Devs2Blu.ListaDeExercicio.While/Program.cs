...
namespace Devs2Blu.ListaDeExercicio.While
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("1 - Exercício01");
                Console.WriteLine("2 - Exercício02");
                Console.WriteLine("3 - Exercício03");
                Console.WriteLine("4 - Exercício04");
                Console.WriteLine("5 - Exercício05");
                Console.WriteLine("6 - Exercício06");
