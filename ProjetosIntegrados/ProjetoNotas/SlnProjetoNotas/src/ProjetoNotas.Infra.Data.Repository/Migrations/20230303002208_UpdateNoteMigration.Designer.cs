...
namespace ProjetoNotas.Infra.Data.Repository.Migrations
{
    ...
    [Migration("20230303002208_UpdateNoteMigration")]
    partial class UpdateNoteMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjetoNotas.Domain.Entities.Note", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fixed = true,
                            TimeNote = new DateTime(2023, 3, 2, 21, 22, 8, 381, DateTimeKind.Local).AddTicks(543),
                            Title = "Lorem",
                            UserId = 1
                        });
                });
